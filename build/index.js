        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!State_1.StateService.runners) {
                    State_1.StateService.initialData = runners;
                ...
                runners.forEach(function (currentRunnerState) {
                    var _a;
                    var runnerPrevState = (_a = State_1.StateService.runnersData) === null || _a === void 0 ? void 0 : _a.find(function (runnerInState) { return runnerInState.id === currentRunnerState.id; });
